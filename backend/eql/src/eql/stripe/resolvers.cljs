...
(pco/defresolver customers
  [{email          :user/email
    limit          ::customers-limit
    starting-after ::customers-starting-after
    stripe         ::stripe-client}]
  {::pco/input  [(pco/? :user/email)
                 ::stripe-client
                 (pco/? ::customers-limit)
                 (pco/? ::customers-starting-after)]
   ::pco/output [::customers]}
  ;; {::customers [:user/email ::stripe-id :eql.cognito/sub]}
  (go
